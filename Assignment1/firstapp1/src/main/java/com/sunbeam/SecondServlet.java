...
@WebServlet(value = "/hello", loadOnStartup = 9,
			initParams = {
					@WebInitParam(name = "color", value = "skyblue"),
...
public class SecondServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		...
		out.println("</head>");
		out.printf("<body align='center' bgcolor='%s'>\n", color);
		out.println("<h1>Hello from SecondSarvlet</h1>");
		Date now = new Date();
